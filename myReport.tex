...
\usepackage{multirow} % อย่าลืมเพิ่มแพ็กเกจนี้ที่ส่วน Header ของเอกสาร
\usepackage{float}       % สำหรับแก้ Error [H]
\usepackage{subcaption}  % สำหรับแก้ Error subtable และ subcaption
...
\titleTH{การใช้สมการสมดุลของแนชกับความมั่นคงความปลอดภัยทางไซเบอร์ในกลศาสตร์\\ควอนตัม}
